...
# ---------------------------------------------------------------------
# Description:  SMSanovapull computes an ANOVA table for Exercise 3.20,
#               in which a company decides to compare three marketing
#               strategies on sales of their 30 shops. Each strategy was
#               tested in 10 of the 30 shops resulting in 3 groups. 
